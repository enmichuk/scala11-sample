...
import org.enmichuk.JsonUtil

object PersonSerialization extends App {
 ...
 */
  ...
  val commandJson = JsonUtil.toJson(UpdateSurfaceCommand2("a", ""))
  println(commandJson)
  // groupJson: String = {"name":"Scala ppl","persons":[{"name":"Jeroen","age":26},{"name":"Martin","age":54}],"leader":{"name":"Martin","age":54}}

  val command = JsonUtil.fromJson[UpdateSurfaceCommand2](commandJson)
  println(command)
...
case class UpdateSurfaceCommand2(name: String, a: String)
